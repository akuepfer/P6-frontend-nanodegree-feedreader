...
$(function() {
    ...
    */
    ...
    /* TODO: Write a new test suite named "New Feed Selection" */
     ...
     describe('New Feed Selection', function() {    // level 0
         var feed_0;
         var feed_1;
         var feed_2;
         var feed_3;
             ...
             describe('level 2', function () {
                 ...
                 describe('level 3', function () {
                     ...
                     it('when a new feed is loaded by the loadFeed function that the content actually changes', function (done) {
                         ...
                         expect(feed_0).not.toEqual(feed_2);
                         expect(feed_0).not.toEqual(feed_3);
                         expect(feed_1).not.toEqual(feed_2);
                         expect(feed_1).not.toEqual(feed_3);
                         expect(feed_2).not.toEqual(feed_3);
                         done();
                     });
